...
//         */ 
//         void InsertDataFile(unsigned long hash, std::array<char, 32> key, std::array<char, 32> value, int starting, bool insert_end)
//         {
//             std::ofstream myfile("tmp_data.txt");
//             int file_size = GetFileSize("data.txt");

//             char* buffer = ReadAllBytes();
...
//                 if (i < starting || i > starting + 80) {
//                     myfile << buffer[i];
//                 } else {
//                     if (i >= starting && i < starting + 16) {
//                         myfile << hash_arr[i];
//                     } else if (i >= starting + 16 && i < starting + 48) {
//                         myfile << key[i];
//                     } else {
//                         myfile << value[i];
//                     }
...
//             int res1 = std::remove("data.txt");
//             int res2 = std::rename("tmp_data.txt", "data.txt");
//             myfile.close();
//         }
...
//                 InsertDataFile(hash, key, value, starting, true);
