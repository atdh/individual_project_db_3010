...
void PutDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PutDialog *_t = static_cast<PutDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (PutDialog::*_t)(std::string , std::string , Response );
...
const QMetaObject PutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PutDialog.data,
      qt_meta_data_PutDialog,  qt_static_metacall, nullptr, nullptr}
};
